...
public class YfinancePriceCrawler(HttpClient httpClient) : IYfinancePriceCrawler
{
        ...
        DateOnly dateTo)
    {
        ...
        var yahooStockId = stockAdapter.ToYahooStockId();
        ...
        var url = $"http://{Config.StockHubApiPyBaseUrl}/hist/{yahooStockId}/?start_date={dateFromActual.ToString("yyyy-MM-dd")}&end_date={dateToActual.ToString("yyyy-MM-dd")}";
